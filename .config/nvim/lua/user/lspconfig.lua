...
local install_status_ok, _ = pcall(require, "nvim-lsp-installer")
...
if not config.rescriptls then
	local path = "/home/nate/projects/rescript-lang/rescript-vscode/server/out/server.js"
